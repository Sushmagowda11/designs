...
!(function (e, t) {
    ...
    var o,
        ...
        _ =
            ...
            {
                set: function (e, t, i) {
                    void 0 === e.bsKey && ((e.bsKey = { key: t, id: r }), r++), (o[e.bsKey.id] = i);
                },
                get: function (e, t) {
                        ...
                        ? (function (e, t, i) {
                              return function n(o) {
                                  for (var r = e.querySelectorAll(t), s = o.target; s && s !== this; s = s.parentNode)
                                      for (var a = r.length; a--; ) if (r[a] === s) return (o.delegateTarget = s), n.oneOff && W.off(e, o.type, i), i.apply(s, [o]);
                                  return null;
                              };
                          })(e, i, n)
                        : (function (e, t) {
    ...
    var W = {
            ...
            trigger: function (e, t, i) {
                ...
                var n,
                    ...
                    u = null;
                return (
                    s && o && ((n = o.Event(t, i)), o(e).trigger(n), (l = !n.isPropagationStopped()), (c = !n.isImmediatePropagationStopped()), (d = n.isDefaultPrevented())),
    ...
    W.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', F.handleDismiss(new F())),
        b(function () {
            var e = y();
            if (e) {
                var t = e.fn[$];
                (e.fn[$] = F.jQueryInterface),
                    (e.fn[$].Constructor = F),
    ...
    function R(e) {
        return "true" === e || ("true" !== e && (e === Number(e).toString() ? Number(e) : "" === e || "null" === e ? null : e));
    }
    function B(e) {
            ...
            return (
                ...
                (r._addTouchEventListeners = function () {
                    var e = this,
                        ...
                        i = function (t) {
                            e._pointerEvent && X[t.pointerType.toUpperCase()] && (e.touchDeltaX = t.clientX - e.touchStartX),
                                e._handleSwipe(),
                        ...
                        if (((this._isSliding = !0), u && this.pause(), this._setActiveIndicatorElement(l), (this._activeElement = l), this._element.classList.contains("slide"))) {
                            ...
                            W.one(s, "transitionend", function () {
                                l.classList.remove(i, n),
                                    ...
                                    (r._isSliding = !1),
                                    setTimeout(function () {
                                        W.trigger(r._element, "slid.bs.carousel", { relatedTarget: l, direction: o, from: a, to: c });
                                    }, 0);
                            }),
                                p(s, f);
                        } else s.classList.remove("active"), l.classList.add("active"), (this._isSliding = !1), W.trigger(this._element, "slid.bs.carousel", { relatedTarget: l, direction: o, from: a, to: c });
                        u && this.cycle();
                    }
                }),
    ...
    W.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", K.dataApiClickHandler),
    ...
    var De = {
            ...
            effect: function (e) {
                ...
                null != r &&
                    ...
                    ((t.elements.arrow = r), (t.modifiersData[n + "#persistent"] = { padding: Se("number" != typeof a ? a : Ce(a, re)) }));
            },
    ...
    function Ee(e) {
        ...
        var y,
            b = Object.assign({ position: s }, l && Oe);
        return a
            ? Object.assign(
                  Object.assign({}, b),
                  {},
                  (((y = {})[m] = p ? "0" : ""), (y[h] = f ? "0" : ""), (y.transform = (g.devicePixelRatio || 1) < 2 ? "translate(" + d + "px, " + u + "px)" : "translate3d(" + d + "px, " + u + "px, 0)"), y)
              )
            : Object.assign(Object.assign({}, b), {}, (((t = {})[m] = p ? u + "px" : ""), (t[h] = f ? d + "px" : ""), (t.transform = ""), t));
    }
    var Ae = {
            name: "computeStyles",
            enabled: !0,
            ...
            fn: function (e) {
                var t = e.state,
                    ...
                    r = i.adaptive,
                    s = void 0 === r || r,
                    a = { placement: he(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: o };
                null != t.modifiersData.popperOffsets &&
                    (t.styles.popper = Object.assign(Object.assign({}, t.styles.popper), Ee(Object.assign(Object.assign({}, a), {}, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: s })))),
                    null != t.modifiersData.arrow && (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), Ee(Object.assign(Object.assign({}, a), {}, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1 })))),
            ...
            ? Re(
                  (function (e) {
                      var t = de(e),
                          ...
                          s = 0,
                          a = 0;
                      return n && ((o = n.width), (r = n.height), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((s = n.offsetLeft), (a = n.offsetTop))), { width: o, height: r, x: s + $e(e), y: a };
                  })(e)
              )
            : fe(t)
            ? (function (e) {
            ...
            : Re(
                  (function (e) {
                      var t = be(e),
                          ...
                          s = -i.scrollLeft + $e(e),
                          a = -i.scrollTop;
                      return "rtl" === ve(n || t).direction && (s += Math.max(t.clientWidth, n ? n.clientWidth : 0) - o), { width: o, height: r, x: s, y: a };
                  })(be(e))
              );
    }
    function qe(e) {
    ...
    function Ue(e, t) {
        ...
        var i = t,
            ...
            _ = We(v),
            k = Ye({ reference: _, element: y, strategy: "absolute", placement: o }),
            x = Re(Object.assign(Object.assign({}, y), k)),
            T = "popper" === d ? x : _,
            S = { top: w.top - T.top + m.top, bottom: T.bottom - w.bottom + m.bottom, left: w.left - T.left + m.left, right: T.right - w.right + m.right },
            ...
            if (!t.modifiersData[n]._skip) {
                for (
                                ...
                                "auto" === he(i)
                                    ? (function (e, t) {
                                          ...
                                          var p = f.reduce(function (t, i) {
                                              return (t[i] = Ue(e, { placement: i, boundary: o, rootBoundary: r, padding: s })[he(i)]), t;
                                          }, {});
                    ...
                    var C = b[S],
                        ...
                        E = [te, ie].indexOf(D) >= 0,
                        A = E ? "width" : "height",
                        M = Ue(t, { placement: C, boundary: d, rootBoundary: u, altBoundary: f, padding: c }),
                        I = E ? (O ? ne : oe) : O ? ie : te;
                    w[A] > _[A] && (I = Pe(I));
                    var L = Pe(I),
                        P = [];
                        ...
                        return (
                            (e[i] = (function (e, t, i) {
                                var n = he(e),
                                    ...
                                    s = r[0],
                                    a = r[1];
                                return (s = s || 0), (a = (a || 0) * o), [oe, ne].indexOf(n) >= 0 ? { x: a, y: s } : { x: s, y: a };
                            })(i, t.rects, r)),
                            e
                        );
                    }, {}),
        ...
        Ze = {
            ...
            fn: function (e) {
                var t = e.state,
                    ...
                    h = i.tetherOffset,
                    m = void 0 === h ? 0 : h,
                    g = Ue(t, { boundary: l, rootBoundary: c, padding: u, altBoundary: d }),
                    v = he(t.placement),
                    y = qe(t.placement),
                    b = !y,
                    w = xe(v),
                ...
                if (k) {
                    if (r) {
                        var D = "y" === w ? te : oe,
                            ...
                            z = "start" === y ? -T[E] : -x[E],
                            j = t.elements.arrow,
                            W = p && j ? me(j) : { width: 0, height: 0 },
                            H = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : { top: 0, right: 0, bottom: 0, left: 0 },
                            $ = H[D],
                            F = H[O],
                            N = Te(0, x[E], W[E]),
    ...
    function et(e, t, i) {
        ...
        return (
            (a || (!a && !i)) &&
                (("body" !== ce(t) || Fe(r)) && (l = (n = t) !== de(n) && fe(n) ? { scrollLeft: (o = n).scrollLeft, scrollTop: o.scrollTop } : He(n)), fe(t) ? (((c = We(t)).x += t.clientLeft), (c.y += t.clientTop)) : r && (c.x = $e(r))),
            ...
            var o,
                ...
                d = {
                    ...
                    setOptions: function (i) {
                        u(), (a.options = Object.assign(Object.assign(Object.assign({}, r), a.options), i)), (a.scrollParents = { reference: ue(e) ? Ne(e) : e.contextElement ? Ne(e.contextElement) : [], popper: Ne(t) });
                        var o,
                            s,
                            c = (function (e) {
                                var t = (function (e) {
                        ...
                        return (
                            ...
                            a.orderedModifiers.forEach(function (e) {
                                ...
                                if ("function" == typeof o) {
                                    var r = o({ state: a, name: t, instance: d, options: n });
                                    l.push(r || function () {});
                                }
                            }),
                            d.update()
                    ...
                    forceUpdate: function () {
                        if (!c) {
                            var e = a.elements,
                                ...
                                i = e.popper;
                            if (it(t, i)) {
                                (a.rects = { reference: et(t, ke(i), "fixed" === a.options.strategy), popper: me(i) }),
                                    (a.reset = !1),
    ...
    var ot = nt(),
        rt = nt({ defaultModifiers: [Ie, Ge, Ae, pe] }),
        st = nt({ defaultModifiers: [Ie, Ge, Ae, pe, Ve, Je, Ze, De, Ke] }),
        at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
            detectOverflow: Ue,
                ...
                (r.show = function () {
                    if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                        ...
                        if (!W.trigger(this._element, "show.bs.dropdown", t).defaultPrevented) {
                            if (!this._inNavbar) {
                                if (void 0 === at) throw new TypeError("Bootstrap's dropdowns require Popper ()");
                                var i = this._element;
                                "parent" === this._config.reference ? (i = e) : f(this._config.reference) && ((i = this._config.reference), void 0 !== this._config.reference.jquery && (i = this._config.reference[0])),
                                    (this._popper = st(i, this._menu, this._getPopperConfig()));
                            }
                            var n;
                        ...
                        for (var t = Y.find('[data-bs-toggle="dropdown"]'), i = 0, n = t.length; i < n; i++) {
                            ...
                            if ((e && "click" === e.type && (a.clickEvent = e), s)) {
                                ...
                                if (
                                    ...
                                    !((e && (("click" === e.type && /input|textarea/i.test(e.target.tagName)) || ("keyup" === e.type && "Tab" === e.key)) && c.contains(e.target)) || W.trigger(r, "hide.bs.dropdown", a).defaultPrevented)
                                )
                                    "ontouchstart" in document.documentElement &&
                                        (l = []).concat.apply(l, document.body.children).forEach(function (e) {
                                            return W.off(e, "mouseover", null, function () {});
                                        }),
                                        t[i].setAttribute("aria-expanded", "true"),
                                        s._popper && s._popper.destroy(),
                                        c.classList.remove("show"),
                                        t[i].classList.remove("show"),
                                        W.trigger(r, "hidden.bs.dropdown", a);
                            }
                        }
                }),
    ...
    var Ct = "tooltip",
        ...
        At = { AUTO: "auto", TOP: "top", RIGHT: w ? "left" : "right", BOTTOM: "bottom", LEFT: w ? "right" : "left" },
        Mt = {
            animation: !0,
        ...
        Lt = (function (e) {
            function o(t, i) {
                var n;
                if (void 0 === at) throw new TypeError("Bootstrap's tooltips require Popper ()");
            ...
            return (
                ...
                (r.toggle = function (e) {
                    if (this._isEnabled)
                        if (e) {
                            ...
                            i || ((i = new this.constructor(e.delegateTarget, this._getDelegateConfig())), k(e.delegateTarget, t, i)),
                ...
                (r.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        k(o, this.constructor.DATA_KEY, this),
                            ...
                            (this._popper = st(this._element, o, this._getPopperConfig(l))),
                ...
                (r._enter = function (e, t) {
                    ...
                    (t = t || x(e.delegateTarget, i)) || ((t = new this.constructor(e.delegateTarget, this._getDelegateConfig())), k(e.delegateTarget, i, t)),
    ...
    var Pt = "popover",
        ...
        jt = i({}, Lt.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' }),
        Wt = i({}, Lt.DefaultType, { content: "(string|element|function)" }),
        Ht = {
    ...
    b(function () {
        ...
        if (e) {
            var t = e.fn[Pt];
            (e.fn[Pt] = $t.jQueryInterface),
                (e.fn[Pt].Constructor = $t),
    ...
    W.on(window, "load.bs.scrollspy.data-api", function () {
        ...
        b(function () {
            ...
            if (e) {
                var t = e.fn[Ft];
                (e.fn[Ft] = Bt.jQueryInterface),
                    (e.fn[Ft].Constructor = Bt),
        ...
        return (
            (o.show = function () {
                ...
                if (!((this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active")) || this._element.classList.contains("disabled"))) {
                    ...
                    var r = null;
                    if ((t && (r = W.trigger(t, "hide.bs.tab", { relatedTarget: this._element })), !(W.trigger(this._element, "show.bs.tab", { relatedTarget: t }).defaultPrevented || (null !== r && r.defaultPrevented)))) {
    ...
    return (
        b(function () {
            ...
            if (e) {
                var t = e.fn.toast;
                (e.fn.toast = Jt.jQueryInterface),
                    (e.fn.toast.Constructor = Jt),
                    (e.fn.toast.noConflict = function () {
                        return (e.fn.toast = t), Jt.jQueryInterface;
                    });
            }
        }),
        { Alert: F, Button: N, Carousel: K, Collapse: ee, Dropdown: yt, Modal: _t, Popover: $t, ScrollSpy: Bt, Tab: qt, Toast: Jt, Tooltip: Lt }
    );
}),
    (function (e, t) {
    ...
    (function (e, t) {
        ...
        return function n(a) {
            if (
                ...
                if ("none" == l.display)
                    return (function () {
                        for (var e = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, t = 0; t < r; t++) e[o[t]] = 0;
                        return e;
                    })();
                var c = {};
    ...
    (function (e, t) {
        ...
        return (
            ...
            (n._getItemLayoutPosition = function (e) {
                ...
                for (var n = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, e), o = { x: this.columnWidth * n.col, y: n.y }, r = n.y + e.size.outerHeight, s = i + n.col, a = n.col; a < s; a++)
                    this.colYs[a] = r;
                return o;
            }),
                ...
                (e = {
                    ...
                    for (var a in this.waypoints[r]) {
                        ...
                        f.element !== f.element.window && (m = f.adapter.offset()[s.offsetProp]),
                            "function" == typeof p ? (p = p.apply(f)) : "string" == typeof p && ((p = parseFloat(p)), f.options.offset.indexOf("%") > -1 && (p = Math.ceil((s.contextDimension * p) / 100))),
                            (l = s.contextScroll - s.contextOffset),
                            (f.triggerPoint = m + l - p),
                            (c = h < s.oldScroll),
                            (d = f.triggerPoint >= s.oldScroll),
                            (u = !c && !d),
                            !g && c && d ? (f.queueTrigger(s.backward), (n[f.group.id] = f.group)) : ((!g && u) || (g && s.oldScroll >= f.triggerPoint)) && (f.queueTrigger(s.forward), (n[f.group.id] = f.group));
                    }
                }
                return (
        ...
        (e = function (e, t) {
            ...
            ((DateFormatter = function (e) {
                ...
                parseDate: function (t, i) {
                    ...
                    for (o = t.replace(p.separators, "\0").split("\0"), r = 0; r < o.length; r++)
                        switch (((s = o[r]), (a = parseInt(s)), n[r])) {
                            case "y":
                            case "Y":
                                if (!a) return null;
                            ...
                            case "g":
                            case "h":
                                if (((f = o[(c = -1 < n.indexOf("a") ? n.indexOf("a") : -1 < n.indexOf("A") ? n.indexOf("A") : -1)]), -1 < c))
                                    (d = e(f, g.meridiem[0]) ? 0 : e(f, g.meridiem[1]) ? 12 : -1), 1 <= a && a <= 12 && -1 < d ? (v.hour = a + d - 1) : 0 <= a && a <= 23 && (v.hour = a);
                                else {
                    ...
                    if (e instanceof Date) {
                        for (o = t.length, i = 0; i < o; i++)
                            "S" !== (s = t.charAt(i)) &&
                                ...
                                (0 < i && "\\" === t.charAt(i - 1)
                                    ? (a += s)
                                    : ((r = this.parseFormat(s, e)), i !== o - 1 && this.intParts.test(s) && "S" === t.charAt(i + 1) && ((n = parseInt(r) || 0), (r += this.dateSettings.ordinal(n))), (a += r)));
                        return a;
                    }
                    return "";
                },
...
var datetimepickerFactory = function (e) {
    ...
    var t = {
        ...
        s = function () {
            ...
            "function" == typeof DateFormatter && (i = n = new DateFormatter({ dateSettings: e.extend({}, r, a) }));
        },
        a = {
            moment: {
            ...
            return this.each(function () {
                ...
                "hide" !== i
                    ? (e(this).hasClass("xdsoft_scroller_box") ||
                          ...
                          s.append(a),
                          l.addClass("xdsoft_scroller_box").append(s),
                          (v = function (e) {
                              var t = c(e).y - f + g;
                                  ...
                                  (o = l[0].clientHeight),
                                      ...
                                      1 < c
                                          ...
                                          : (a.show(),
                                            ...
                                            (d = s[0].offsetHeight - a[0].offsetHeight),
                                            !0 !== i && l.trigger("scroll_element.xdsoft_scroller", [t || Math.abs(parseInt(n.css("marginTop"), 10)) / (r - o)]));
                              }),
            ...
            return (
                (s = function (t) {
                    ...
                    S.id && O.attr("id", S.id),
                        ...
                        M.find(".xdsoft_month span").after(W),
                        M.find(".xdsoft_year span").after(H),
                        M.find(".xdsoft_month,.xdsoft_year").on("touchstart mousedown.xdsoft", function (t) {
                            var i,
                                n,
                                ...
                                a = o.is(":visible");
                            for (
                                M.find(".xdsoft_select").hide(), C.currentTime && (r = C.currentTime[e(this).hasClass("xdsoft_month") ? "getMonth" : "getFullYear"]()), o[a ? "hide" : "show"](), i = o.find("div.xdsoft_option"), n = 0;
                    ...
                    function B(n) {
                        ...
                        n.mask && t.off("keydown.xdsoft"),
                            ...
                            "string" === e.type(n.mask) &&
                                (o(n.mask, t.val()) || (t.val(n.mask.replace(/[0-9]/g, "_")), r(t[0], 0)),
                                t.on("paste.xdsoft", function (i) {
                                    ...
                                    return (
                                        (a = a.substr(0, l) + s + a.substr(l + s.length)),
                                        (l += s.length),
                                        o(n.mask, a) ? ((this.value = a), r(this, l)) : "" === e.trim(a) ? (this.value = n.mask.replace(/[0-9]/g, "_")) : t.trigger("error_input.xdsoft"),
                                        i.preventDefault(),
                                        !1
                                    );
                                }),
                                t.on("keydown.xdsoft", function (i) {
                                    ...
                                    if ((48 <= l && l <= 57) || (96 <= l && l <= 105) || 8 === l || 46 === l) {
                                        ...
                                        for (d += 8 === l ? 0 : 1; /[^0-9_]/.test(n.mask.substr(d, 1)) && d < n.mask.length && 0 < d; ) d += 8 === l ? 0 : 1;
                    ...
                    M.find(".xdsoft_select")
                        ...
                        .on("touchend mousedown.xdsoft", ".xdsoft_option", function () {
                            if (!this.touchMoved) {
                                ...
                                C && C.currentTime && C.currentTime[e(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"](e(this).data("value")),
                                    ...
                                    S.onChangeMonth && e.isFunction(S.onChangeMonth) && S.onChangeMonth.call(O, C.currentTime, O.data("input")),
                                    t !== C.currentTime.getFullYear() && e.isFunction(S.onChangeYear) && S.onChangeYear.call(O, C.currentTime, O.data("input"));
                            }
                        }),
                        (O.getValue = function () {
                            ...
                            (S = e.extend(!0, {}, S, n)),
                                ...
                                n.highlightedPeriods &&
                                    ...
                                    e.each(n.highlightedPeriods, function (t, n) {
                                        ...
                                        for (; r <= s; )
                                            (l = new d(r, a, f)),
                                                (c = i.formatDate(r, S.formatDate)),
                                                r.setDate(r.getDate() + 1),
                                                void 0 !== o[c] ? (u = o[c].desc) && u.length && l.desc && l.desc.length && (o[c].desc = u + "\n" + l.desc) : (o[c] = l);
                                    }),
                                    (S.highlightedDates = e.extend(!0, [], o))),
                                ...
                                S.inline && (($ = !0), O.addClass("xdsoft_inline"), t.after(O).hide()),
                                S.inverseButton && ((S.next = "xdsoft_prev"), (S.prev = "xdsoft_next")),
                                S.datepicker ? A.addClass("active") : A.removeClass("active"),
                                S.timepicker ? L.addClass("active") : L.removeClass("active"),
                                ...
                                S.timepickerScrollbar || P.xdsoftScroller(S, "hide"),
                                ...
                                j.toggle(S.showApplyButton),
                                M.find(".xdsoft_today_button").css("visibility", S.todayButton ? "visible" : "hidden"),
                                M.find("." + S.prev).css("visibility", S.prevButton ? "visible" : "hidden"),
                                M.find("." + S.next).css("visibility", S.nextButton ? "visible" : "hidden"),
                                B(S),
                                S.validateOnBlur &&
                        ...
                        O.append(A).append(L),
                        !0 !== S.withoutCopyright && O.append(E),
                        A.append(M).append(I).append(j),
                            ...
                            (t.now = function (e) {
                                ...
                                (t.nextMonth = function () {
                                    ...
                                    return (
                                        ...
                                        S.onChangeMonth && e.isFunction(S.onChangeMonth) && S.onChangeMonth.call(O, C.currentTime, O.data("input")),
                                        i !== t.currentTime.getFullYear() && e.isFunction(S.onChangeYear) && S.onChangeYear.call(O, C.currentTime, O.data("input")),
                                        O.trigger("xchange.xdsoft"),
                                        n
                                    );
                                }),
                                ...
                                (t.strToDateTime = function (e) {
                                    ...
                                    return e && e instanceof Date && t.isValidDate(e)
                                        ? e
                                        : ((r = /^([+-]{1})(.*)$/.exec(e)) && (r[2] = i.parseDate(r[2], S.formatDate)),
                                          (o = r && r[2] ? ((n = r[2].getTime() - 6e4 * r[2].getTimezoneOffset()), new Date(t.now(!0).getTime() + parseInt(r[1] + "1", 10) * n)) : e ? i.parseDate(e, S.format) : t.now()),
                            ...
                            .on("dblclick.xdsoft", function () {
                                ...
                                (n = new Date(n.getFullYear(), n.getMonth(), n.getDate())),
                                    ...
                                    n < (e = new Date(e.getFullYear(), e.getMonth(), e.getDate())) ||
                                        ((i = C.strToDate(S.maxDate)), (i = new Date(i.getFullYear(), i.getMonth(), i.getDate())) < n || (t.val(C.str()), t.trigger("change"), O.trigger("close.xdsoft")));
                            }),
                        ...
                        L.find(".xdsoft_prev,.xdsoft_next").on("touchend mousedown.xdsoft", function () {
                            ...
                            !(function e(r) {
                                ...
                                t.hasClass(S.next) && a - s - S.timeHeightInTimePicker >= l
                                    ? z.css("marginTop", "-" + (l + S.timeHeightInTimePicker) + "px")
                                    : t.hasClass(S.prev) && 0 <= l - S.timeHeightInTimePicker && z.css("marginTop", "-" + (l - S.timeHeightInTimePicker) + "px"),
                                    P.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(z[0].style.marginTop, 10) / (a - s))]),
                                    (o = 10 < o ? 10 : o - 10),
                                    n || (i = setTimeout(e, r || o));
                            })(500),
                                e([S.ownerDocument.body, S.contentWindow]).on("touchend mouseup.xdsoft", function t() {
                                    clearTimeout(i), (n = !0), e([S.ownerDocument.body, S.contentWindow]).off("touchend mouseup.xdsoft", t);
                                });
                        ...
                        (r = 0),
                        O.on("xchange.xdsoft", function (s) {
                            clearTimeout(r),
                                (r = setTimeout(function () {
                                    (void 0 !== C.currentTime && null !== C.currentTime) || (C.currentTime = C.now());
                                    for (
                                        var r, s, a, l, c, d, u, f, p, h, m = "", g = new Date(C.currentTime.getFullYear(), C.currentTime.getMonth(), 1, 12, 0, 0), v = 0, y = C.now(), b = !1, w = !1, _ = !1, k = !1, x = [], T = !0, D = "";
                                    ...
                                    for (
                                        m += "</tr></thead>",
                                            ...
                                            !1 !== S.minDate && ((w = C.strToDate(S.minDate)), (w = new Date(w.getFullYear(), w.getMonth(), w.getDate()))),
                                            !1 !== S.minDateTime && ((_ = C.strToDate(S.minDateTime)), (_ = new Date(_.getFullYear(), _.getMonth(), _.getDate(), _.getHours(), _.getMinutes(), _.getSeconds()))),
                                            !1 !== S.maxDateTime && ((k = C.strToDate(S.maxDateTime)), (k = new Date(k.getFullYear(), k.getMonth(), k.getDate(), k.getHours(), k.getMinutes(), k.getSeconds()))),
                                        ...
                                        (x = []),
                                            ...
                                            (p = ""),
                                            x.push("xdsoft_date"),
                                            (u = S.beforeShowDay && e.isFunction(S.beforeShowDay.call) ? S.beforeShowDay.call(O, g) : null),
                                            S.allowDateRe && "[object RegExp]" === Object.prototype.toString.call(S.allowDateRe) && (S.allowDateRe.test(i.formatDate(g, S.formatDate)) || x.push("xdsoft_disabled")),
                                            S.allowDates && 0 < S.allowDates.length && -1 === S.allowDates.indexOf(i.formatDate(g, S.formatDate)) && x.push("xdsoft_disabled");
                                        var E = 31 * (12 * g.getFullYear() + g.getMonth()) + g.getDate();
                                        ((!1 !== b && b < g) || (!1 !== _ && g < _) || (!1 !== w && g < w) || (!1 !== k && h < E) || (u && !1 === u[0])) && x.push("xdsoft_disabled"),
                                            -1 !== S.disabledDates.indexOf(i.formatDate(g, S.formatDate)) && x.push("xdsoft_disabled"),
                                            -1 !== S.disabledWeekDays.indexOf(a) && x.push("xdsoft_disabled"),
                                            t.is("[disabled]") && x.push("xdsoft_disabled"),
                                            u && "" !== u[1] && x.push(u[1]),
                                            C.currentTime.getMonth() !== j && x.push("xdsoft_other_month"),
                                            (S.defaultSelect || O.data("changed")) && i.formatDate(C.currentTime, S.formatDate) === i.formatDate(g, S.formatDate) && x.push("xdsoft_current"),
                                            i.formatDate(y, S.formatDate) === i.formatDate(g, S.formatDate) && x.push("xdsoft_today"),
                                            (0 !== g.getDay() && 6 !== g.getDay() && -1 === S.weekends.indexOf(i.formatDate(g, S.formatDate))) || x.push("xdsoft_weekend"),
                                            void 0 !== S.highlightedDates[i.formatDate(g, S.formatDate)] &&
                                                ((s = S.highlightedDates[i.formatDate(g, S.formatDate)]), x.push(void 0 === s.style ? "xdsoft_highlighted_default" : s.style), (p = void 0 === s.desc ? "" : s.desc)),
                                            S.beforeShowDay && e.isFunction(S.beforeShowDay) && x.push(S.beforeShowDay(g)),
                                            T && ((m += "<tr>"), (T = !1), S.weeks && (m += "<th>" + d + "</th>")),
                                            (m +=
                                                '<td data-date="' +
                                                l +
                                                '" data-month="' +
                                    ...
                                    (m += "</tbody></table>"),
                                        I.html(m),
                                        M.find(".xdsoft_label span").eq(0).text(S.i18n[o].months[C.currentTime.getMonth()]),
                                    ...
                                    var P = 1440;
                                    if (
                                        (!1 !== S.maxTime && ((L = C.strtotime(S.maxTime)), (P = 60 * L.getHours() + L.getMinutes())),
                                        !1 !== S.minDateTime && ((L = C.strToDateTime(S.minDateTime)), i.formatDate(C.currentTime, S.formatDate) === i.formatDate(L, S.formatDate)))
                                    ) {
                                        var j = 60 * L.getHours() + L.getMinutes();
                                        A < j && (A = j);
                                    }
                                    if (
                                        (!1 !== S.maxDateTime && ((L = C.strToDateTime(S.maxDateTime)), i.formatDate(C.currentTime, S.formatDate) === i.formatDate(L, S.formatDate) && (j = 60 * L.getHours() + L.getMinutes()) < P && (P = j)),
                                        (f = function (n, o) {
                                            var r,
                                                s = C.now(),
                                            ...
                                            var l = 60 * n + o;
                                            (t.is("[disabled]") || P <= l || l < A) && x.push("xdsoft_disabled"),
                                                (r = new Date(C.currentTime)).setHours(parseInt(C.currentTime.getHours(), 10)),
                                                a || r.setMinutes(Math[S.roundTime](C.currentTime.getMinutes() / S.step) * S.step),
                                                (S.initTime || S.defaultSelect || O.data("changed")) &&
                                                    r.getHours() === parseInt(n, 10) &&
                                                    ((!a && 59 < S.step) || r.getMinutes() === parseInt(o, 10)) &&
                                                    (S.defaultSelect || O.data("changed") ? x.push("xdsoft_current") : S.initTime && x.push("xdsoft_init_time")),
                                                parseInt(y.getHours(), 10) === parseInt(n, 10) && parseInt(y.getMinutes(), 10) === parseInt(o, 10) && x.push("xdsoft_today"),
                                                (D += '<div class="xdsoft_time ' + x.join(" ") + '" data-hour="' + n + '" data-minute="' + o + '">' + i.formatDate(s, S.formatTime) + "</div>");
                                        }),
                                    ...
                                    for (z.html(D), n = "", v = parseInt(S.yearStart, 10); v <= parseInt(S.yearEnd, 10); v += 1)
                                        n += '<div class="xdsoft_option ' + (C.currentTime.getFullYear() === v ? "xdsoft_current" : "") + '" data-value="' + v + '">' + (v + S.yearOffset) + "</div>";
                                    for (H.children().eq(0).html(n), v = parseInt(S.monthStart, 10), n = ""; v <= parseInt(S.monthEnd, 10); v += 1)
                            ...
                            var e, t, i, n;
                            S.timepicker &&
                                (z.find(".xdsoft_current").length ? (e = ".xdsoft_current") : z.find(".xdsoft_init_time").length && (e = ".xdsoft_init_time"),
                                e
                                    ? ((t = P[0].clientHeight), (i = z[0].offsetHeight) - t < (n = z.find(e).index() * S.timeHeightInTimePicker + 1) && (n = i - t), P.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (i - t)]))
                        ...
                        I.on("touchend click.xdsoft", "td", function (i) {
                            ...
                            o.setDate(1),
                                ...
                                t.val(C.str()),
                                S.onSelectDate && e.isFunction(S.onSelectDate) && S.onSelectDate.call(O, C.currentTime, O.data("input"), i),
                                O.data("changed", !0),
                                O.trigger("xchange.xdsoft"),
                                O.trigger("changedatetime.xdsoft"),
                                (1 < s || !0 === S.closeOnDateSelect || (!1 === S.closeOnDateSelect && !S.timepicker)) && !S.inline && O.trigger("close.xdsoft"),
                                setTimeout(function () {
                                    s = 0;
                                }, 200);
                        }),
                            ...
                            .on("touchend click.xdsoft", "div", function (t) {
                                if (!this.touchMoved) {
                                    ...
                                    n.setHours(i.data("hour")),
                                        ...
                                        S.onSelectTime && e.isFunction(S.onSelectTime) && S.onSelectTime.call(O, C.currentTime, O.data("input"), t),
                                        O.data("changed", !0),
                                        O.trigger("xchange.xdsoft"),
                                        O.trigger("changedatetime.xdsoft"),
                                        !0 !== S.inline && !0 === S.closeOnTimeSelect && O.trigger("close.xdsoft");
                                }
                            }),
                        ...
                        t.on("mousewheel.xdsoft", function (e) {
                            return (
                                ...
                                (!S.datepicker && S.timepicker
                                    ? (0 <= (a = z.find(".xdsoft_current").length ? z.find(".xdsoft_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < z.children().length && (a += e.deltaY),
                                      z.children().eq(a).length && z.children().eq(a).trigger("mousedown"),
                                      !1)
                                    : S.datepicker && !S.timepicker
                                    ? (A.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), t.val && t.val(C.str()), O.trigger("changedatetime.xdsoft"), !1)
                                    : void 0)
                            );
                        }),
                        ...
                        (l = function () {
                            ...
                            if (
                                ...
                                (p = e(S.contentWindow).scrollTop()),
                                S.ownerDocument.documentElement.clientWidth - t.left < A.parent().outerWidth(!0))
                            ) {
                                var h = A.parent().outerWidth(!0) - i.offsetWidth;
                                o -= h;
                            }
                            "rtl" === l.parent().css("direction") && (o -= O.outerWidth() - l.outerWidth()),
                                S.fixed
                                    ? ((n -= p), (o -= e(S.contentWindow).scrollLeft()), (r = "fixed"))
                                    : ((a = !1),
                                      D(i, function (e) {
                                          return null !== e && ("fixed" === S.contentWindow.getComputedStyle(e).getPropertyValue("position") ? !(a = !0) : void 0);
                                      }),
                                      a && !S.insideParent ? ((r = "fixed"), n + O.outerHeight() > f + p ? ((d = "bottom"), (n = f + p - t.top)) : (n -= p)) : n + O[0].offsetHeight > f + p && (n = t.top - O[0].offsetHeight + 1),
                                      n < 0 && (n = 0),
                                      o + i.offsetWidth > c && (o = c - i.offsetWidth)),
                                (s = O[0]),
                                D(s, function (e) {
                                    if ("relative" === S.contentWindow.getComputedStyle(e).getPropertyValue("position") && c >= e.offsetWidth) return (o -= (c - e.offsetWidth) / 2), !1;
                                }),
                                (u = { position: r, left: S.insideParent ? i.offsetLeft : o, top: "", bottom: "" }),
                                S.insideParent ? (u[d] = i.offsetTop + i.offsetHeight) : (u[d] = n),
                                O.css(u);
                        }),
                        O.on("open.xdsoft", function (t) {
                            var i = !0;
                            S.onShow && e.isFunction(S.onShow) && (i = S.onShow.call(O, C.currentTime, O.data("input"), t)),
                                !1 !== i &&
                                    (O.show(),
                                    l(),
                            ...
                            .on("close.xdsoft", function (t) {
                                ...
                                M.find(".xdsoft_month,.xdsoft_year").find(".xdsoft_select").hide(),
                                    S.onClose && e.isFunction(S.onClose) && (i = S.onClose.call(O, C.currentTime, O.data("input"), t)),
                        ...
                        t
                            ...
                            .on("keydown.xdsoft", function (t) {
                                ...
                                return -1 !== [u].indexOf(n) && S.enterLikeTab
                                    ? ((i = e("input:visible,textarea:visible,button:visible,a:visible")), O.trigger("close.xdsoft"), i.eq(i.index(this) + 1).focus(), !1)
                                    : -1 !== [v].indexOf(n)
    ...
    (function (e) {
        ...
        function l(n) {
            ...
            if (
                ...
                "axis" in s && s.axis === s.HORIZONTAL_AXIS && ((f = -1 * p), (p = 0)),
                (u = 0 === p ? f : p),
                "deltaY" in s && (u = p = -1 * s.deltaY),
                "deltaX" in s && ((f = s.deltaX), 0 === p && (u = -1 * f)),
                0 !== p || 0 !== f)
            ) {
                if (1 === s.deltaMode) {
            ...
            open: function (i) {
                ...
                if (!t.isOpen) {
                    (t.types = []),
                        ...
                        t.bgOverlay ||
                            ((t.bgOverlay = _("bg").on("click" + p, function () {
                                t.close();
                            })),
                            (t.wrap = _("wrap")
                                .attr("tabindex", -1)
                ...
                getImage: function (i, n) {
                    var o = 0,
                        r = function () {
                            i &&
                                (i.img[0].complete
                                    ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), (i.hasSize = !0), (i.loaded = !0), k("ImageLoadComplete"))
                                    : 200 > ++o
                                    ? setTimeout(r, 100)
                                    : s());
                        },
                    ...
                    return (
                        ...
                        t.resizeImage(),
                        i.hasSize
                            ? (P && clearInterval(P), i.loadError ? (n.addClass("mfp-loading"), t.updateStatus("error", a.tError.replace("%url%", i.src))) : (n.removeClass("mfp-loading"), t.updateStatus("ready")), n)
    ...
    t && Object.deepExtend(n, t),
        ...
        (n.fn.particle = function (e, t, i) {
            ...
            n.particles.move.straight
                ? ((this.vx = r.x), (this.vy = r.y), n.particles.move.random && ((this.vx = this.vx * Math.random()), (this.vy = this.vy * Math.random())))
            ...
            if ("image" == this.shape) {
                ...
                (this.img = { src: l.image.src, ratio: l.image.width / l.image.height }),
                    ...
                    "svg" == n.tmp.img_type && null != n.tmp.source_svg && (n.fn.vendors.createSvgImg(this), n.tmp.pushing && (this.img.loaded = !1));
            }
        }),
        (n.fn.particle.prototype.draw = function () {
            ...
            switch (((n.canvas.ctx.fillStyle = o), n.canvas.ctx.beginPath(), e.shape)) {
                ...
                case "triangle":
                    ...
                    break;
                case "polygon":
                    n.fn.vendors.drawShape(n.canvas.ctx, e.x - t / (n.particles.shape.polygon.nb_sides / 3.5), e.y - t / 0.76, (2.66 * t) / (n.particles.shape.polygon.nb_sides / 3), n.particles.shape.polygon.nb_sides, 1);
                    break;
                case "star":
            ...
            for (var e = 0; e < n.particles.array.length; e++) {
                ...
                if (
                    (n.particles.opacity.anim.enable &&
                        (1 == t.opacity_status ? (t.opacity >= n.particles.opacity.value && (t.opacity_status = !1), (t.opacity += t.vo)) : (t.opacity <= n.particles.opacity.anim.opacity_min && (t.opacity_status = !0), (t.opacity -= t.vo)),
                        t.opacity < 0 && (t.opacity = 0)),
                    n.particles.size.anim.enable &&
                        (1 == t.size_status ? (t.radius >= n.particles.size.value && (t.size_status = !1), (t.radius += t.vs)) : (t.radius <= n.particles.size.anim.size_min && (t.size_status = !0), (t.radius -= t.vs)),
                        t.radius < 0 && (t.radius = 0)),
                    "bounce" == n.particles.move.out_mode)
                )
                    var o = { x_left: t.radius, x_right: n.canvas.w, y_top: t.radius, y_bottom: n.canvas.h };
                else o = { x_left: -t.radius, x_right: n.canvas.w + t.radius, y_top: -t.radius, y_bottom: n.canvas.h + t.radius };
                switch (
                    (t.x - t.radius > n.canvas.w ? ((t.x = o.x_left), (t.y = Math.random() * n.canvas.h)) : t.x + t.radius < 0 && ((t.x = o.x_right), (t.y = Math.random() * n.canvas.h)),
                    t.y - t.radius > n.canvas.h ? ((t.y = o.y_top), (t.x = Math.random() * n.canvas.w)) : t.y + t.radius < 0 && ((t.y = o.y_bottom), (t.x = Math.random() * n.canvas.w)),
                ...
                if (
                    (isInArray("grab", n.interactivity.events.onhover.mode) && n.fn.modes.grabParticle(t),
        ...
        (n.fn.modes.pushParticles = function (e, t) {
            n.tmp.pushing = !0;
            for (var i = 0; e > i; i++)
                n.particles.array.push(new n.fn.particle(n.particles.color, n.particles.opacity.value, { x: t ? t.pos_x : Math.random() * n.canvas.w, y: t ? t.pos_y : Math.random() * n.canvas.h })),
        ...
        (n.fn.modes.bubbleParticle = function (e) {
            ...
            if (n.interactivity.events.onhover.enable && isInArray("bubble", n.interactivity.events.onhover.mode)) {
                ...
                n.tmp.bubble_clicking &&
                    (i(n.interactivity.modes.bubble.size, n.particles.size.value, e.radius_bubble, e.radius, "size"), i(n.interactivity.modes.bubble.opacity, n.particles.opacity.value, e.opacity_bubble, e.opacity, "opacity"));
            }
        }),
...
(Object.deepExtend = function (e, t) {
    ...
    (function (e) {
        ...
        ((t = (function () {
            ...
            this.$slideTrack.find(".slick-active").attr({ "aria-hidden": "true" }).find("a, input, button, select").attr({ tabindex: "0" });
        }),
            ...
            (t.prototype.setSlideClasses = function (e) {
                ...
                if (((i = r.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true")), r.$slides.eq(e).addClass("slick-current"), !0 === r.options.centerMode)) {
                    ...
                    e >= 0 && e <= r.slideCount - r.options.slidesToShow
                        ...
                        ? i.addClass("slick-active").attr("aria-hidden", "true")
            ...
            (t.prototype.updateArrows = function () {
                ...
                Math.floor(e.options.slidesToShow / 2),
                    !0 === e.options.arrows &&
                        e.slideCount > e.options.slidesToShow &&
                        !e.options.infinite &&
                        (e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled", "true"),
                        e.$nextArrow.removeClass("slick-disabled").attr("aria-disabled", "true"),
                        0 === e.currentSlide
                            ? (e.$prevArrow.addClass("slick-disabled").attr("aria-disabled", "true"), e.$nextArrow.removeClass("slick-disabled").attr("aria-disabled", "true"))
                            : ((e.currentSlide >= e.slideCount - e.options.slidesToShow && !1 === e.options.centerMode) || (e.currentSlide >= e.slideCount - 1 && !0 === e.options.centerMode)) &&
                              (e.$nextArrow.addClass("slick-disabled").attr("aria-disabled", "true"), e.$prevArrow.removeClass("slick-disabled").attr("aria-disabled", "true")));
            }),
