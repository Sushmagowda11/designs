    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-12">
                <p style="line-height: 34px;font-size: 14px;margin-bottom: 0px;"><i class="fal fa-location-dot"></i> Pickup: <span style="font-size: 12px;font-weight:300"><?php echo $_POST['floc']; ?></span></p>
            </div>
            <div class="col-md-3 col-12">
                <p style="line-height: 34px;font-size: 14px;margin-bottom: 0px;"><i class="fal fa-location-dot"></i> Drop: <span style="font-size: 12px;font-weight:300"><?php echo $_POST['tloc']; ?></span></p>
            </div>
                ...
                <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php if(floatval($result) >='130'){ echo round(($result*13)+400); } else{ echo round((130*13)+400); } ?> <br />
                                ...
                                <p><?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } // getDistance($_POST['fromlocation'], $_POST['tolocation'], "K"); ?> package <span style="font-weight: 500; font-size: 12px;">Excludes Toll & GST</span></p>
                            </div>
                            <div class="col-3">
                                <div class="row">
                            ...
                            <div class="col-md-12">
                              <p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id01').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>
						        ...
						        <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?>" required name="km" />
						        <input type="hidden" placeholder="Name" value="Rs 13/km" required name="extra" />
                                ...
                                <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                ...
                                <input  name="pickup_address" placeholder="Journey Date" value="<?php echo $_POST['pickup_address']; ?>" type="hidden">
                                <input type="hidden" class="form-control" value="<?php echo $_POST['rtime']; ?>" placeholder="Journey Time" name="reservation_time" />
                                
                                <div class="form-btn">
                                    <button type="submit" name="oneway" class="as-btn w-100" style="color: #000">Book Car</button>
                    ...
                    <div class="col-md-12">
                        <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <h6 style="color: #22a9d7; margin-bottom: 8px;">
                                        ₹<?php if(floatval($result) >='130'){ echo round(($result*14)+400); } else{ echo round((130*14)+400); } ?> <br />
                                        <?php if(floatval($result) >='130'){ $mn = round(($result*14)+400); } else{ $mn = round((130*14)+400); } ?>
                                        <?php
                                                    $tm = (($mn*10)/100)+$mn;
                                                ?>
                                        <span style="color: #b12704; margin-bottom: 8px;">
                                            <s>₹<?php echo $tm; ?></s>
                                        </span>
                                    </h6>
                                    <p>
                                        <?php  if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } // getDistance($_POST['fromlocation'], $_POST['tolocation'], "K"); ?> package
                                        <span style="font-weight: 500; font-size: 12px;">Excludes Toll & GST</span>
                                    </p>
                                    <!--<p>2142 package <span style="font-weight: 500; font-size: 12px;margin-bottom:8px">Includes Toll & GST</span></p>-->
                                </div>
                                <div class="col-3">
                                   
                                                <p style="text-align: center; text-align: center; margin-bottom: 9px; font-size: 12px; cursor: pointer;">
                                                    <a onclick="document.getElementById('id02').style.display='block'" style="color: #1b6bb0;">More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a>
                                                </p>
                                                ...
                                                <form action="thankyou.php" method="post">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?>" required name="km" />
                                                        <input type="hidden" placeholder="Name" value="Rs 14/km" required name="extra" />
                                                        <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php if(floatval($result) >='130'){ echo round(($result*19)+400); } else{ echo round((130*19)+400); } ?> <br />
                                    <?php if(floatval($result) >='130'){ $mn = round(($result*19)+400); } else{ $mn = round((130*19)+400); } ?>
                                    <?php
                                        $tm = (($mn*10)/100)+$mn;
                                    ?>
                                    <span style="color: #b12704;margin-bottom:8px"><s>₹<?php echo $tm; ?></s></span>
                            ...
                            <div class="col-3">
                                            ...
                                            <div class="col-md-12">
                                              <!--<p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id02').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>-->
                						        ...
                						        <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?>" required name="km" />
                						        <input type="hidden" placeholder="Name" value="Rs 17/km" required name="extra" />
                							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
                							    <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo round(($result*19)+400); } else{ echo round((130*19)+400); } ?>" required name="amount" />
                                                <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                                <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                                <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                                <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
       ...
       <div class="col-md-12">
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php if(floatval($result) >='130'){ echo round(($result*24)+400); } else{ echo round((130*24)+400); } ?> <br />
                                    <?php if(floatval($result) >='130'){ $mn = round(($result*24)+400); } else{ $mn = round((130*24)+400); } ?>
                                    <?php
                                        $tm = (($mn*10)/100)+$mn;
                                    ?>
                                    <span style="color: #b12704;margin-bottom:8px"><s>₹<?php echo $tm; ?></s></span>
                            ...
                            <div class="col-md-12">
                              <!--<p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id02').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>-->
						        ...
						        <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?>" required name="km" />
						        <input type="hidden" placeholder="Name" value="Rs 18/km" required name="extra" />
							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
							    <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo round(($result*24)+400); } else{ echo round((130*24)+400); } ?>" required name="amount" />
                                <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
        ...
        <div class="col-md-12">
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            ...
                            <div class="col-3">
                                 <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php if(floatval($result) >='130'){ echo round(($result*32)+400); } else{ echo round((130*32)+400); } ?> <br />
                                    <?php if(floatval($result) >='130'){ $mn = round(($result*32)+400); } else{ $mn = round((130*32)+400); } ?>
                                    <?php
                                        $tm = (($mn*10)/100)+$mn;
                                    ?>
                                    <span style="color: #b12704;margin-bottom:8px"><s>₹<?php echo $tm; ?></s></span>
                            ...
                            <div class="col-md-12">
                              <!--<p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id02').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>-->
						        ...
						        <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?>" required name="km" />
						        <input type="hidden" placeholder="Name" value="Rs 20/km" required name="extra" />
							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
							    <input type="hidden" placeholder="Name" value="<?php if(floatval($result) >='130'){ echo round(($result*32)+400); } else{ echo round((130*32)+400); } ?>" required name="amount" />
                                <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="container" style="padding: 10px;border-radius: 10px;box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                              <div class="col-4">
                                   <p style="font-size: 16px; font-weight: 700;margin-bottom:8px;margin-left:25px">
                                    Sedan <br />
                                  
                                </p>
                                <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
                                <img src="assets/img/c1.png" class="center1"/>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <p style="display:none"><?php  if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } // getDistance($_POST['fromlocation'], $_POST['tolocation'], "K"); ?> package <span style="font-weight: 500; font-size: 12px;">Excludes Toll & GST</span></p>
                            </div>
                            <div class="col-4">
                                <div class="row">
                            <form action="thankyou.php" method="post">
                    ...
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
                                <img src="assets/img/c2.png" class="center1" />
                            </div>
                    ...
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
                                <img src="assets/img/c3.png" class="center1" />
                            </div>
                    ...
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
                                <img src="assets/img/c4.png" class="center1" />
                            </div>
                    ...
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            <div class="col-4">
                                ...
                                <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
                                <img src="assets/img/c5.png" class="center1" />
                            </div>
...
<div id="" class="modal">
    <form class="modal-content animate" action="/action_page.php" method="post">
        ...
        <div class="container" style="padding: 16px; margin-top: -20px;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹13/km after <?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?> km</p>
                    <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                    <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                    <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                    <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹13/km after <?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?></p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹14/km after <?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?></p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹19/km after <?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?></p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹24/km after <?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?></p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/facilities_icon1.png" style="width: 8%;" /> 6+1 and 7+1</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/facilities_icon2.png" style="width: 8%;" /> 2 bags</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/facilities_icon3.png" style="width: 8%;" /> AC</p>
                        </div>
                    </div>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹32/km after <?php if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } ?></p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
