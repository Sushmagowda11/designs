...
function dateDifference($start_date, $end_date)
{
    ...
    {
       // start date 
        $start_date = $_POST['rdate'];
          
        // end date 
        $end_date = $_POST['rdate1'];
        
        $days = dateDifference($start_date, $end_date);
        
        $to_date = ($_POST['rdate']);// Input your date here e.g. strtotime("2014-01-02")
        $from_date = ($_POST['rdate1']);
        $days1 = $to_date - $from_date;
        // echo $days = floor($day_diff/(60*60*24))."\n";
...
<div class="space">
    <div class="container">
        <div class="car car1">
            <div class="row">
                <div class="col-12">
                    <h2 class="sec-title">Round Trip</h2>
                </div>
                <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php echo $tamt =  round($days*(300*13)); //echo round($days*(300*11)+($days*400)); ?> <br />
                                    <?php
                                    //if(floatval($result) >='130'){ $mn = round(($result*11)+400); } else{ $mn = round((130*11)+400); } 
                                    ?>
                                    <?php
                                        $tm = (($tamt*10)/100)+$tamt;
                                    ?>
                                ...
                                <p><?php echo $days*300; //if(floatval($result) >='130'){ echo $result; }else{ echo "130"; } // getDistance($_POST['fromlocation'], $_POST['tolocation'], "K"); ?> kms package <span style="font-weight: 500; font-size: 12px;">Excludes Toll & GST</span></p>
                            ...
                            <div class="col-md-12">
                              <p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id01').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>
							    ...
							    <input type="hidden" placeholder="Name" value="<?php echo $tamt =  round($days*(300*13)); ?>" required name="amount" />
                                ...
                                <input  name="reservation_date1" placeholder="Journey Date" value="<?php echo $_POST['rdate1']; ?>" type="hidden">
                                <input type="hidden" class="form-control" value="<?php echo $_POST['rtime']; ?>" placeholder="Journey Time" name="reservation_time" />
                                <input type="hidden" placeholder="Name" value="<?php echo $days; ?>" required name="days" />
                                <input  name="pickup_address" placeholder="Journey Date" value="<?php echo $_POST['pickup_address']; ?>" type="hidden">
                                <div class="form-btn">
                                    <button type="submit" name="roundtrip" class="as-btn w-100" style="color: #000">Book Car</button>
                ...
                <div class="col-md-12">
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php echo $tamt =  round($days*(300*14)); //echo round($days*(300*11)+($days*400)); ?> <br />
                                    <?php
                                    //if(floatval($result) >='130'){ $mn = round(($result*11)+400); } else{ $mn = round((130*11)+400); } 
                                    ?>
                                    <?php
                                ...
                                <!--<p>2142 package <span style="font-weight: 500; font-size: 12px;margin-bottom:8px">Excludes Toll & GST</span></p>-->
                            </div>
                            <div class="col-3">
                                <form action="thankyou.php" method="post">
                                    <div class="col-md-12">
                                      <p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id02').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>
        							    ...
        							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
        							    <input type="hidden" placeholder="Name" value="<?php echo $tamt =  round($days*(300*14)); ?>" required name="amount" />
                                        <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                        <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                        <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                        <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
                ...
                <div class="col-md-12">
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php echo $tamt =  round($days*(300*16)); //echo round($days*(300*11)+($days*400)); ?> <br />
                                    <?php
                                    //if(floatval($result) >='130'){ $mn = round(($result*11)+400); } else{ $mn = round((130*11)+400); } 
                                    ?>
                                    <?php
                                ...
                                <form action="thankyou.php" method="post">
                                    <div class="col-md-12">
                                      <p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id03').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>
        						        ...
        						        <input type="hidden" placeholder="Name" value="<?php echo $days*300; ?>" required name="km" />
        						        <input type="hidden" placeholder="Name" value="Rs 16/km" required name="extra" />
        							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
        							    <input type="hidden" placeholder="Name" value="<?php echo $tamt =  round($days*(300*16)); ?>" required name="amount" />
                                        <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                        <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                        <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                        <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
                ...
                <div class="col-md-12">
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php echo $tamt =  round($days*(300*17)); //echo round($days*(300*11)+($days*400)); ?> <br />
                                    <?php
                                    //if(floatval($result) >='130'){ $mn = round(($result*11)+400); } else{ $mn = round((130*11)+400); } 
                                    ?>
                                    <?php
                                ...
                                <form action="thankyou.php" method="post">
                                    <div class="col-md-12">
                                      <p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id04').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>
        							    ...
        							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
        							    <input type="hidden" placeholder="Name" value="<?php echo $tamt =  round($days*(300*17)); ?>" required name="amount" />
                                        <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                        <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                        <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                        <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
                ...
                <div class="col-md-12">
                    <div class="container" style="padding: 10px; border-radius: 10px; box-shadow: rgb(152 147 147 / 50%) 0px 0px 20px 0px;margin:10px 0px">
                        <div class="row">
                            ...
                            <div class="col-3">
                                <h6 style="color: #22a9d7;margin-bottom:8px">
                                    ₹<?php echo $tamt =  round($days*(300*20)); //echo round($days*(300*11)+($days*400)); ?> <br />
                                    <?php
                                    //if(floatval($result) >='130'){ $mn = round(($result*11)+400); } else{ $mn = round((130*11)+400); } 
                                    ?>
                                    <?php
                                ...
                                <form action="thankyou.php" method="post">
                                    <div class="col-md-12">
                                      <p style='text-align:center;text-align: center;margin-bottom: 9px;color: #1b6bb0;font-size: 12px;cursor: pointer;'> <a onclick="document.getElementById('id05').style.display='block'" >More Info <i class="fa fa-info-circle" aria-hidden="true"></i></a></p>
        							    ...
        							    <input type="hidden" placeholder="Name" value="<?php echo $_POST['name']; ?>" required name="name" />
        							    <input type="hidden" placeholder="Name" value="<?php echo $tamt =  round($days*(300*20)); ?>" required name="amount" />
                                        <input  type="hidden" value="<?php echo $_POST['floc']; ?>" name="fromlocation" required size="50" placeholder="Enter a location"  />  
                                        <input type="hidden" value="<?php echo $_POST['tloc']; ?>" size="50" name="tolocation" required placeholder="Enter a location" />  
                                        <input type="hidden" placeholder="Email Id" required value="<?php echo $_POST['email']; ?>" name="email" />
                                        <input type="hidden" placeholder="Contact Number" value="<?php echo $_POST['mobile']; ?>" name="number" required />
            ...
            <div class="container" style="padding-right: 0px; padding-left: 0px;">
                <div class="row">
                    <div class="col-6">
                        ...
                        <p>2142 kms package <span style="font-weight: 500; font-size: 12px;">Excludes Toll & GST</span></p>
                    </div>
                    <div class="col-6">
                        <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
            ...
            <div class="container" style="padding-right: 0px; padding-left: 0px;">
                <div class="row">
                    <div class="col-6">
                        ...
                        <p>2142 kms package <span style="font-weight: 500; font-size: 12px;margin-bottom:8px">Excludes Toll & GST</span></p>
                    </div>
                    <div class="col-6">
                     <!--<p style='float:right'><a onclick="document.getElementById('id01').style.display='block'" ><i class="fa fa-cogs" aria-hidden="true"></i></a></p>-->
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹13/km after <?php echo $days*300; ?> km</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹14/km after <?php echo $days*300; ?> km</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹19/km after <?php echo $days*300; ?> km</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹24/km after <?php echo $days*300; ?> km</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
        ...
        <div class='row'>
            ...
            <div class='col-md-4'>
                <div class="container" style="padding: 16px; margin-top: -20px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon2.png" style="width: 8%;" /> Pay ₹32/km after <?php echo $days*300; ?> km</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Multiple pickups/drops</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon3.png" style="width: 8%;" /> Parking</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/exclusions_icon1.png" style="width: 8%;" /> State Tax & Toll</p>
                            <p style="font-size: 12px;"><img src="assets/img/cars/inclusions_icon3.png" style="width: 8%;" /> GST (5%)</p>
